...
var currentUser;   //only global this page.
...
function displayCardsDynamically(collection) {
    let cardTemplate = document.getElementById("hikeCardTemplate"); // 定位（location）---Retrieve the HTML element with the ID "hikeCardTemplate" and store it in the cardTemplate variable. 
    ...
    .get()   //the collection called "hikes"
        .then(allHikes=> {
            ...
            allHikes.forEach(doc => { //iterate thru each doc
                ...
                document.getElementById(collection + "-go-here").appendChild(newcard); // 定位（location）
